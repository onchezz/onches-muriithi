          ...
          >
            ...
            <div className={`${index % 2 === 0 ? 'md:pr-8' : 'md:col-start-3 md:pl-8'} col-span-1 md:col-span-1`}>
              <motion.div
                ...
                className="p-6 bg-[#1A1A1A] rounded-lg border border-[#FFB6A3] border-opacity-20 hover:border-opacity-40 transition-all transform-gpu hover:scale-105 shadow-lg"
              >
